    ...
    <div className="calculator">
      <div className="selectWrapper">
        <div className="select">
          <div className="selectTitle">Start</div>
          {selectList[0] && (
            <div className="selectInfo">
              ...
              <div className="selectLatLong">
                <span>Lat:</span> {selectList[0].properties.lat}°,{" "}
                <span>Long:</span> {selectList[0].properties.lon}°
              </div>
            </div>
          )}
          {!selectList[0] && (
        ...
        <div className="select">
          <div className="selectTitle">Destination</div>
          {selectList[1] && (
            <div className="selectInfo">
              <div className="selectAddress">
              ...
              <div className="selectLatLong">
                <span>Lat:</span> {selectList[1].properties.lat}°,{" "}
                <span>Long:</span> {selectList[1].properties.lon}°
              </div>
            </div>
          )}
          {!selectList[1] && (
        ...
        <div className="select">
          <div className="selectTitle">Distance</div>
          {distance && (
